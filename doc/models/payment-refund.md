...
|  --- | --- | --- | --- | --- | --- |
| `id` | `string` |  | The unique ID for this refund, generated by Square. | getId(): string | setId(string id): void |
...
| `locationId` | `?string` | Optional | The location ID associated with the payment this refund is attached to. | getLocationId(): ?string | setLocationId(?string locationId): void |
...
| `createdAt` | `?string` | Optional | The timestamp of when the refund was created, in RFC 3339 format. | getCreatedAt(): ?string | setCreatedAt(?string createdAt): void |
| `updatedAt` | `?string` | Optional | The timestamp of when the refund was last updated, in RFC 3339 format. | getUpdatedAt(): ?string | setUpdatedAt(?string updatedAt): void |
