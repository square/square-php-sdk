...
| `count` | `?bool` | Optional | Indicates whether to return the total count of customers in the `count` field of the response.<br><br>The default value is `false`. | getCount(): ?bool | setCount(?bool count): void |
