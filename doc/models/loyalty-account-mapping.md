...
| `type` | `string` |  | The type of mapping.<br>**Default**: `'PHONE'`<br>*Default: `'PHONE'`* | getType(): string | setType(string type): void |
| `value` | `string` |  | The phone number, in E.164 format. For example, "+14155551111".<br>**Constraints**: *Minimum Length*: `1` | getValue(): string | setValue(string value): void |
