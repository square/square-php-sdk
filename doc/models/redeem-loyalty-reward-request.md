...
| `locationId` | `string` | Required | The ID of the [location](../../doc/models/location.md) where the reward is redeemed.<br>**Constraints**: *Minimum Length*: `1` | getLocationId(): string | setLocationId(string locationId): void |
