...
|  --- | --- | --- | --- | --- | --- |
| `attributeName` | `string` |  | The attribute whose value is used as the sort key.<br>**Constraints**: *Minimum Length*: `1` | getAttributeName(): string | setAttributeName(string attributeName): void |
