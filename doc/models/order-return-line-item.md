...
| `catalogObjectId` | `?string` | Optional | The [CatalogItemVariation](/doc/models/catalog-item-variation.md) id applied to this returned line item.<br>**Constraints**: *Maximum Length*: `192` | getCatalogObjectId(): ?string | setCatalogObjectId(?string catalogObjectId): void |
