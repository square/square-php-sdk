...
|  --- | --- | --- | --- | --- | --- |
| `field` | `string` | Required | The field to use for sorting.<br>**Default**: `'INVOICE_SORT_DATE'`<br>*Default: `'INVOICE_SORT_DATE'`* | getField(): string | setField(string field): void |
