...
| `buyerPhoneNumber` | `?string` | Optional | The buyer's phone number.<br>Must follow the following format:<br><br>1. A leading + symbol (followed by a country code)<br>2. The phone number can contain spaces and the special characters `(` , `)` , `-` , and `.`.<br>   Alphabetical characters aren't allowed.<br>3. The phone number must contain between 9 and 16 digits. | getBuyerPhoneNumber(): ?string | setBuyerPhoneNumber(?string buyerPhoneNumber): void |
