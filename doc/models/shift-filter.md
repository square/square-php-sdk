...
|  --- | --- | --- | --- | --- | --- |
| `locationIds` | `string[]` |  | Fetch shifts for the specified location. | getLocationIds(): array | setLocationIds(array locationIds): void |
...
| `teamMemberIds` | `string[]` |  | Fetch shifts for the specified team members. Replaced `employee_ids` at version "2020-08-26" | getTeamMemberIds(): array | setTeamMemberIds(array teamMemberIds): void |
