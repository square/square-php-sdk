...
| `status` | `?string` | Optional | The status of the `TerminalRefund`.<br>Options: `PENDING`, `IN\_PROGRESS`, `CANCELED`, `COMPLETED` | getStatus(): ?string | setStatus(?string status): void |
