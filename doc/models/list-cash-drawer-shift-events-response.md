...
| `cashDrawerShiftEvents` | [`?(CashDrawerShiftEvent[])`](../../doc/models/cash-drawer-shift-event.md) | Optional | All of the events (payments, refunds, etc.) for a cash drawer during<br>the shift. | getCashDrawerShiftEvents(): ?array | setCashDrawerShiftEvents(?array cashDrawerShiftEvents): void |
