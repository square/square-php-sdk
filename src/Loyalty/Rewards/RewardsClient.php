...
use Square\Loyalty\Rewards\Requests\CreateLoyaltyRewardRequest;
use Square\Types\CreateLoyaltyRewardResponse;
...
use Square\Loyalty\Rewards\Requests\DeleteRewardsRequest;
use Square\Types\DeleteLoyaltyRewardResponse;
use Square\Loyalty\Rewards\Requests\RedeemLoyaltyRewardRequest;
use Square\Types\RedeemLoyaltyRewardResponse;
...
class RewardsClient
{
     ...
     *
     * @param CreateLoyaltyRewardRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function create(CreateLoyaltyRewardRequest $request, ?array $options = null): CreateLoyaltyRewardResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return CreateLoyaltyRewardResponse::fromJson($json);
            }
     ...
     * @throws SquareApiException
     */
    public function get(GetRewardsRequest $request, ?array $options = null): GetLoyaltyRewardResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Production->value,
                    path: "v2/loyalty/rewards/{$request->getRewardId()}",
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return GetLoyaltyRewardResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SquareException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     *
     * @param DeleteRewardsRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SquareApiException
     */
    public function delete(DeleteRewardsRequest $request, ?array $options = null): DeleteLoyaltyRewardResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return DeleteLoyaltyRewardResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SquareException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     * to the account.
     *
     * @param RedeemLoyaltyRewardRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SquareApiException
     */
    public function redeem(RedeemLoyaltyRewardRequest $request, ?array $options = null): RedeemLoyaltyRewardResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Production->value,
                    path: "v2/loyalty/rewards/{$request->getRewardId()}/redeem",
                    method: HttpMethod::POST,
                    body: $request,
                ),
                $options,
