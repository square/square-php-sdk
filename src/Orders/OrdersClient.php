...
use Square\Orders\CustomAttributeDefinitions\CustomAttributeDefinitionsClient;
use Square\Orders\CustomAttributes\CustomAttributesClient;
use GuzzleHttp\ClientInterface;
use Square\Core\Client\RawClient;
use Square\Types\CreateOrderRequest;
use Square\Types\CreateOrderResponse;
...
use Square\Types\BatchGetOrdersResponse;
use Square\Orders\Requests\CalculateOrderRequest;
use Square\Types\CalculateOrderResponse;
...
use Square\Types\UpdateOrderResponse;
use Square\Orders\Requests\PayOrderRequest;
use Square\Types\PayOrderResponse;
...
class OrdersClient
{
     ...
     *
     * @param BatchGetOrdersRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SquareApiException
     */
    public function batchGet(BatchGetOrdersRequest $request, ?array $options = null): BatchGetOrdersResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return BatchGetOrdersResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SquareException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     *
     * @param CalculateOrderRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SquareApiException
     */
    public function calculate(CalculateOrderRequest $request, ?array $options = null): CalculateOrderResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return CalculateOrderResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SquareException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     * @throws SquareApiException
     */
    public function clone(CloneOrderRequest $request, ?array $options = null): CloneOrderResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return CloneOrderResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SquareException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     * @throws SquareApiException
     */
    public function get(GetOrdersRequest $request, ?array $options = null): GetOrderResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Production->value,
                    path: "v2/orders/{$request->getOrderId()}",
     ...
     * @throws SquareApiException
     */
    public function update(UpdateOrderRequest $request, ?array $options = null): UpdateOrderResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return UpdateOrderResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SquareException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     * @throws SquareApiException
     */
    public function pay(PayOrderRequest $request, ?array $options = null): PayOrderResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Production->value,
                    path: "v2/orders/{$request->getOrderId()}/pay",
                    method: HttpMethod::POST,
                    body: $request,
                ),
                $options,
