...
class LaborApi extends BaseApi
{
     ...
     *
     * @param string|null $locationId Filter Break Types returned to only those that are associated
     *        with the
     *        specified location.
     * @param int|null $limit Maximum number of Break Types to return per page. Can range between 1
     ...
     * @param int|null $limit Maximum number of Employee Wages to return per page. Can range between
     ...
     *
     * @param string|null $teamMemberId Filter wages returned to only those that are associated with
     *        the
