 ...
 */
class TeamMemberCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"team_member.created"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?TeamMemberCreatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?TeamMemberCreatedEventData $data;
    ...
    /**
     * @return ?TeamMemberCreatedEventData
     */
    public function getData(): ?TeamMemberCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?TeamMemberCreatedEventData $value
     */
    public function setData(?TeamMemberCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
