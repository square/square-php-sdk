 ...
 */
class LaborScheduledShiftDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `labor.scheduled_shift.deleted`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LaborScheduledShiftDeletedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LaborScheduledShiftDeletedEventData $data;
    ...
    /**
     * @return ?LaborScheduledShiftDeletedEventData
     */
    public function getData(): ?LaborScheduledShiftDeletedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LaborScheduledShiftDeletedEventData $value
     */
    public function setData(?LaborScheduledShiftDeletedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
