 ...
 */
class CustomerCustomAttributeUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"customer.custom_attribute.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
