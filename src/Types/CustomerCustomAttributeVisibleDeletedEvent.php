 ...
 */
class CustomerCustomAttributeVisibleDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"customer.custom_attribute.visible.deleted"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
