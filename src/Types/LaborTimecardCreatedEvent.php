 ...
 */
class LaborTimecardCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `labor.timecard.created`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LaborTimecardCreatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LaborTimecardCreatedEventData $data;
    ...
    /**
     * @return ?LaborTimecardCreatedEventData
     */
    public function getData(): ?LaborTimecardCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LaborTimecardCreatedEventData $value
     */
    public function setData(?LaborTimecardCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
