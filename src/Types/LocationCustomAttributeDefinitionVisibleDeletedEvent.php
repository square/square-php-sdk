 ...
 */
class LocationCustomAttributeDefinitionVisibleDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"location.custom_attribute_definition.visible.deleted"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
