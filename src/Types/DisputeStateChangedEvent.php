 ...
 */
class DisputeStateChangedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?DisputeStateChangedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?DisputeStateChangedEventData $data;
     ...
     *   eventId?: ?string,
     *   createdAt?: ?string,
     *   data?: ?DisputeStateChangedEventData,
     * } $values
     */
    ...
    /**
     * @return ?DisputeStateChangedEventData
     */
    public function getData(): ?DisputeStateChangedEventData
    {
        return $this->data;
    }

    /**
     * @param ?DisputeStateChangedEventData $value
     */
    public function setData(?DisputeStateChangedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
