 ...
 */
class TeamMemberUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"team_member.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?TeamMemberUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?TeamMemberUpdatedEventData $data;
    ...
    /**
     * @return ?TeamMemberUpdatedEventData
     */
    public function getData(): ?TeamMemberUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?TeamMemberUpdatedEventData $value
     */
    public function setData(?TeamMemberUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
