 ...
 */
class LoyaltyPromotionCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `loyalty.promotion.created`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LoyaltyPromotionCreatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LoyaltyPromotionCreatedEventData $data;
    ...
    /**
     * @return ?LoyaltyPromotionCreatedEventData
     */
    public function getData(): ?LoyaltyPromotionCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LoyaltyPromotionCreatedEventData $value
     */
    public function setData(?LoyaltyPromotionCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
