...
class Dimension extends JsonSerializableType
{
    /**
     * @var string $name
     */
    ...
    /**
     * @var ?string $aliasMember When dimension is defined in View, it keeps the original path: Cube.dimension
     */
    #[JsonProperty('aliasMember')]
    private ?string $aliasMember;

    /**
     * @var ?array<DimensionGranularity> $granularities
     */
    ...
    /**
     * @var ?value-of<DimensionOrder> $order
     */
    #[JsonProperty('order')]
     ...
     *   description?: ?string,
     *   aliasMember?: ?string,
     *   granularities?: ?array<DimensionGranularity>,
    ...
    /**
     * @return ?array<DimensionGranularity>
     */
    ...
    /**
     * @param ?array<DimensionGranularity> $value
     */
    ...
    /**
     * @return ?value-of<DimensionOrder>
     */
    ...
    /**
     * @param ?value-of<DimensionOrder> $value
     */
