 ...
 */
class OrderFulfillmentUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"order.fulfillment.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?OrderFulfillmentUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?OrderFulfillmentUpdatedEventData $data;
    ...
    /**
     * @return ?OrderFulfillmentUpdatedEventData
     */
    public function getData(): ?OrderFulfillmentUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?OrderFulfillmentUpdatedEventData $value
     */
    public function setData(?OrderFulfillmentUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
