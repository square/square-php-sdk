 ...
 */
class UpdateMerchantCustomAttributeDefinitionResponse extends JsonSerializableType
{
    /**
     * @var ?CustomAttributeDefinition $customAttributeDefinition The updated custom attribute definition.
     */
