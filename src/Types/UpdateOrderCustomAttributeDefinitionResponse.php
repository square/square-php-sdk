 ...
 */
class UpdateOrderCustomAttributeDefinitionResponse extends JsonSerializableType
{
    /**
     * @var ?CustomAttributeDefinition $customAttributeDefinition The updated order custom attribute definition.
     */
