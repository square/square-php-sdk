 ...
 */
class CardCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"card.created"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?CardCreatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?CardCreatedEventData $data;
    ...
    /**
     * @param ?CardCreatedEventData $value
     */
    public function setData(?CardCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
