 ...
 */
class InvoicePaymentMadeEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"invoice.payment_made"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?InvoicePaymentMadeEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?InvoicePaymentMadeEventData $data;
    ...
    /**
     * @return ?InvoicePaymentMadeEventData
     */
    public function getData(): ?InvoicePaymentMadeEventData
    {
        return $this->data;
    }

    /**
     * @param ?InvoicePaymentMadeEventData $value
     */
    public function setData(?InvoicePaymentMadeEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
