 ...
 */
class LaborScheduledShiftPublishedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `labor.scheduled_shift.published`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LaborScheduledShiftPublishedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LaborScheduledShiftPublishedEventData $data;
    ...
    /**
     * @return ?LaborScheduledShiftPublishedEventData
     */
    public function getData(): ?LaborScheduledShiftPublishedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LaborScheduledShiftPublishedEventData $value
     */
    public function setData(?LaborScheduledShiftPublishedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
