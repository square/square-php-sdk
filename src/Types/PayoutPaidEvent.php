 ...
 */
class PayoutPaidEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"payout.paid"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?PayoutPaidEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?PayoutPaidEventData $data;
    ...
    /**
     * @return ?PayoutPaidEventData
     */
    public function getData(): ?PayoutPaidEventData
    {
        return $this->data;
    }

    /**
     * @param ?PayoutPaidEventData $value
     */
    public function setData(?PayoutPaidEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
