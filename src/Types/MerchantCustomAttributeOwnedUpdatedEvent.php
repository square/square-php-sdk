 ...
 */
class MerchantCustomAttributeOwnedUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"merchant.custom_attribute.owned.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
