...
class CatalogObjectItem extends JsonSerializableType
{
    use CatalogObjectBase;

    /**
     * @var ?CatalogItem $itemData Structured data for a `CatalogItem`, set for CatalogObjects of type `ITEM`.
     */
    ...
    public function __construct(
        ...
        $this->itemData = $values['itemData'] ?? null;
    }
