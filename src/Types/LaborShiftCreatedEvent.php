 ...
 */
class LaborShiftCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `labor.shift.created`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LaborShiftCreatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LaborShiftCreatedEventData $data;
    ...
    /**
     * @return ?LaborShiftCreatedEventData
     */
    public function getData(): ?LaborShiftCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LaborShiftCreatedEventData $value
     */
    public function setData(?LaborShiftCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
