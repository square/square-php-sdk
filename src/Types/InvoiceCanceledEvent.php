 ...
 */
class InvoiceCanceledEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"invoice.canceled"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?InvoiceCanceledEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?InvoiceCanceledEventData $data;
    ...
    /**
     * @return ?InvoiceCanceledEventData
     */
    public function getData(): ?InvoiceCanceledEventData
    {
        return $this->data;
    }

    /**
     * @param ?InvoiceCanceledEventData $value
     */
    public function setData(?InvoiceCanceledEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
