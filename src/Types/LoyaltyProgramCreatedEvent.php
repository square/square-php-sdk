 ...
 */
class LoyaltyProgramCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `loyalty.program.created`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LoyaltyProgramCreatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LoyaltyProgramCreatedEventData $data;
    ...
    /**
     * @return ?LoyaltyProgramCreatedEventData
     */
    public function getData(): ?LoyaltyProgramCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LoyaltyProgramCreatedEventData $value
     */
    public function setData(?LoyaltyProgramCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
