 ...
 */
class InvoiceRefundedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"invoice.refunded"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?InvoiceRefundedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?InvoiceRefundedEventData $data;
    ...
    /**
     * @return ?InvoiceRefundedEventData
     */
    public function getData(): ?InvoiceRefundedEventData
    {
        return $this->data;
    }

    /**
     * @param ?InvoiceRefundedEventData $value
     */
    public function setData(?InvoiceRefundedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
