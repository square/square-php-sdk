 ...
 */
class DisputeEvidenceRemovedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?DisputeEvidenceRemovedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?DisputeEvidenceRemovedEventData $data;
    ...
    /**
     * @return ?DisputeEvidenceRemovedEventData
     */
    public function getData(): ?DisputeEvidenceRemovedEventData
    {
        return $this->data;
    }

    /**
     * @param ?DisputeEvidenceRemovedEventData $value
     */
    public function setData(?DisputeEvidenceRemovedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
