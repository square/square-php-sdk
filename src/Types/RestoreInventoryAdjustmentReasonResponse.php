 ...
 */
class RestoreInventoryAdjustmentReasonResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?InventoryAdjustmentReason $adjustmentReason The successfully restored inventory adjustment reason.
     */
