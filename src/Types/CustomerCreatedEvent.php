 ...
 */
class CustomerCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this object, the value is `customer.created`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?CustomerCreatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?CustomerCreatedEventData $data;
    ...
    /**
     * @param ?CustomerCreatedEventData $value
     */
    public function setData(?CustomerCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
