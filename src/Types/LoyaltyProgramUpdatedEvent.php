 ...
 */
class LoyaltyProgramUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `loyalty.program.updated`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LoyaltyProgramUpdatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LoyaltyProgramUpdatedEventData $data;
    ...
    /**
     * @return ?LoyaltyProgramUpdatedEventData
     */
    public function getData(): ?LoyaltyProgramUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LoyaltyProgramUpdatedEventData $value
     */
    public function setData(?LoyaltyProgramUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
