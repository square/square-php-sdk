 ...
 */
class BookingCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"booking.created"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?BookingCreatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?BookingCreatedEventData $data;
    ...
    /**
     * @return ?BookingCreatedEventData
     */
    public function getData(): ?BookingCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?BookingCreatedEventData $value
     */
    public function setData(?BookingCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
