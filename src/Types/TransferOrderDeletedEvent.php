 ...
 */
class TransferOrderDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"transfer_order.deleted"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?TransferOrderDeletedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?TransferOrderDeletedEventData $data;
    ...
    /**
     * @return ?TransferOrderDeletedEventData
     */
    public function getData(): ?TransferOrderDeletedEventData
    {
        return $this->data;
    }

    /**
     * @param ?TransferOrderDeletedEventData $value
     */
    public function setData(?TransferOrderDeletedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
