 ...
 */
class DisputeEvidenceAddedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?DisputeEvidenceAddedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?DisputeEvidenceAddedEventData $data;
    ...
    /**
     * @return ?DisputeEvidenceAddedEventData
     */
    public function getData(): ?DisputeEvidenceAddedEventData
    {
        return $this->data;
    }

    /**
     * @param ?DisputeEvidenceAddedEventData $value
     */
    public function setData(?DisputeEvidenceAddedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
