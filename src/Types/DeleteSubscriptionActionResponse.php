 ...
 * endpoint.
 */
class DeleteSubscriptionActionResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?Subscription $subscription The subscription that has the specified action deleted.
     */
