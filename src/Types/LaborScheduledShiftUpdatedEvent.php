 ...
 */
class LaborScheduledShiftUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `labor.scheduled_shift.updated`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LaborScheduledShiftUpdatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LaborScheduledShiftUpdatedEventData $data;
    ...
    /**
     * @return ?LaborScheduledShiftUpdatedEventData
     */
    public function getData(): ?LaborScheduledShiftUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LaborScheduledShiftUpdatedEventData $value
     */
    public function setData(?LaborScheduledShiftUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
