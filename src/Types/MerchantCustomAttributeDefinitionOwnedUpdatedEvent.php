 ...
 */
class MerchantCustomAttributeDefinitionOwnedUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"merchant.custom_attribute_definition.owned.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
