 ...
 */
class OrderCustomAttributeDefinitionVisibleCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"order.custom_attribute_definition.visible.created"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
