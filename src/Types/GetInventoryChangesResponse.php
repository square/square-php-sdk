...
class GetInventoryChangesResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<InventoryChange> $changes The set of inventory changes for the requested object and locations.
     */
