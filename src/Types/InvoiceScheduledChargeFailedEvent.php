 ...
 */
class InvoiceScheduledChargeFailedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"invoice.scheduled_charge_failed"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?InvoiceScheduledChargeFailedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?InvoiceScheduledChargeFailedEventData $data;
    ...
    /**
     * @return ?InvoiceScheduledChargeFailedEventData
     */
    public function getData(): ?InvoiceScheduledChargeFailedEventData
    {
        return $this->data;
    }

    /**
     * @param ?InvoiceScheduledChargeFailedEventData $value
     */
