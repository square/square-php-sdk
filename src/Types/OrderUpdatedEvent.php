 ...
 */
class OrderUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"order.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?OrderUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?OrderUpdatedEventData $data;
    ...
    /**
     * @param ?OrderUpdatedEventData $value
     */
    public function setData(?OrderUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
