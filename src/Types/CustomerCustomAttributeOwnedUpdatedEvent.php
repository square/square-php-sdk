 ...
 */
class CustomerCustomAttributeOwnedUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"customer.custom_attribute.owned.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
