 ...
 */
class SubscriptionCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"subscription.created"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?SubscriptionCreatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?SubscriptionCreatedEventData $data;
    ...
    /**
     * @return ?SubscriptionCreatedEventData
     */
    public function getData(): ?SubscriptionCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?SubscriptionCreatedEventData $value
     */
    public function setData(?SubscriptionCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
