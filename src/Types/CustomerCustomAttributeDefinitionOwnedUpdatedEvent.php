 ...
 */
class CustomerCustomAttributeDefinitionOwnedUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"customer.custom_attribute_definition.owned.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
