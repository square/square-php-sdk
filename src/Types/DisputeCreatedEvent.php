 ...
 */
class DisputeCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?DisputeCreatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?DisputeCreatedEventData $data;
    ...
    /**
     * @return ?DisputeCreatedEventData
     */
    public function getData(): ?DisputeCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?DisputeCreatedEventData $value
     */
