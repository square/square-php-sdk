 ...
 * present.
 */
class UpdateWebhookSubscriptionResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?WebhookSubscription $subscription The updated [Subscription](entity:WebhookSubscription).
     */
