 ...
 */
class JobUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"job.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?JobUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?JobUpdatedEventData $data;
    ...
    /**
     * @return ?JobUpdatedEventData
     */
    public function getData(): ?JobUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?JobUpdatedEventData $value
     */
    public function setData(?JobUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
