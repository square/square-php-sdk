 ...
 */
class CardUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"card.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?CardUpdatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?CardUpdatedEventData $data;
    ...
    /**
     * @return ?CardUpdatedEventData
     */
    public function getData(): ?CardUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?CardUpdatedEventData $value
     */
    public function setData(?CardUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
