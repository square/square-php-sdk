 ...
 */
class InvoiceCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"invoice.created"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?InvoiceCreatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?InvoiceCreatedEventData $data;
    ...
    /**
     * @return ?InvoiceCreatedEventData
     */
    public function getData(): ?InvoiceCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?InvoiceCreatedEventData $value
     */
    public function setData(?InvoiceCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
