 ...
 */
class LocationCustomAttributeDefinitionOwnedDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"location.custom_attribute_definition.owned.deleted"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
