 ...
 */
class DisputeEvidenceCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?DisputeEvidenceCreatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?DisputeEvidenceCreatedEventData $data;
     ...
     *   eventId?: ?string,
     *   createdAt?: ?string,
     *   data?: ?DisputeEvidenceCreatedEventData,
     * } $values
     */
    ...
    /**
     * @return ?DisputeEvidenceCreatedEventData
     */
    public function getData(): ?DisputeEvidenceCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?DisputeEvidenceCreatedEventData $value
     */
    public function setData(?DisputeEvidenceCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
