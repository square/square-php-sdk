 ...
 */
class StartTransferOrderResponse extends JsonSerializableType
{
    /**
     * @var ?TransferOrder $transferOrder The updated transfer order with status changed to STARTED
     */
