 ...
 */
class LaborShiftDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `labor.shift.deleted`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LaborShiftDeletedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LaborShiftDeletedEventData $data;
    ...
    /**
     * @return ?LaborShiftDeletedEventData
     */
    public function getData(): ?LaborShiftDeletedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LaborShiftDeletedEventData $value
     */
    public function setData(?LaborShiftDeletedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
