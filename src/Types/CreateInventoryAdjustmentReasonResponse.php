 ...
 */
class CreateInventoryAdjustmentReasonResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?InventoryAdjustmentReason $adjustmentReason The successfully created inventory adjustment reason.
     */
