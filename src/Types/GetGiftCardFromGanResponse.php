 ...
 */
class GetGiftCardFromGanResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?GiftCard $giftCard A gift card that was fetched, if present. It returns empty if an error occurred.
     */
