 ...
 */
class InvoiceDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"invoice.deleted"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?InvoiceDeletedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?InvoiceDeletedEventData $data;
    ...
    /**
     * @return ?InvoiceDeletedEventData
     */
    public function getData(): ?InvoiceDeletedEventData
    {
        return $this->data;
    }

    /**
     * @param ?InvoiceDeletedEventData $value
     */
    public function setData(?InvoiceDeletedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
