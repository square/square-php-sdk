 ...
 */
class GiftCardUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. For this event, the value is `gift_card.updated`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?GiftCardUpdatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?GiftCardUpdatedEventData $data;
    ...
    /**
     * @return ?GiftCardUpdatedEventData
     */
    public function getData(): ?GiftCardUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?GiftCardUpdatedEventData $value
     */
    public function setData(?GiftCardUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
