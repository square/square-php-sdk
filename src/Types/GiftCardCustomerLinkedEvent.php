 ...
 */
class GiftCardCustomerLinkedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `gift_card.customer_linked`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?GiftCardCustomerLinkedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?GiftCardCustomerLinkedEventData $data;
    ...
    /**
     * @return ?GiftCardCustomerLinkedEventData
     */
    public function getData(): ?GiftCardCustomerLinkedEventData
    {
        return $this->data;
    }

    /**
     * @param ?GiftCardCustomerLinkedEventData $value
     */
    public function setData(?GiftCardCustomerLinkedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
