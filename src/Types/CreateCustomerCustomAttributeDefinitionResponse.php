 ...
 */
class CreateCustomerCustomAttributeDefinitionResponse extends JsonSerializableType
{
    /**
     * @var ?CustomAttributeDefinition $customAttributeDefinition The new custom attribute definition.
     */
