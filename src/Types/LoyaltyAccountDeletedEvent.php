 ...
 */
class LoyaltyAccountDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `loyalty.account.deleted`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LoyaltyAccountDeletedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LoyaltyAccountDeletedEventData $data;
    ...
    /**
     * @return ?LoyaltyAccountDeletedEventData
     */
    public function getData(): ?LoyaltyAccountDeletedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LoyaltyAccountDeletedEventData $value
     */
    public function setData(?LoyaltyAccountDeletedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
