 ...
 */
class MerchantCustomAttributeVisibleDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"merchant.custom_attribute.visible.deleted"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
