 ...
 */
class CustomerCustomAttributeDefinitionDeletedPublicEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"customer.custom_attribute_definition.public.deleted"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
