 ...
 */
class InventoryCountUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?InventoryCountUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?InventoryCountUpdatedEventData $data;
    ...
    /**
     * @return ?InventoryCountUpdatedEventData
     */
    ...
    /**
     * @param ?InventoryCountUpdatedEventData $value
     */
    public function setData(?InventoryCountUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
