 ...
 */
class BookingUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"booking.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?BookingUpdatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?BookingUpdatedEventData $data;
    ...
    /**
     * @return ?BookingUpdatedEventData
     */
    public function getData(): ?BookingUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?BookingUpdatedEventData $value
     */
    public function setData(?BookingUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
