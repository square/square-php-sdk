 ...
 */
class CreateDisputeEvidenceTextResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?DisputeEvidence $evidence The newly uploaded dispute evidence metadata.
     */
