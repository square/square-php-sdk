 ...
 */
class CustomerCustomAttributeDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"customer.custom_attribute.deleted"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
