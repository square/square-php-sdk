 ...
 */
class OrderCustomAttributeDefinitionVisibleDeletedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"order.custom_attribute_definition.visible.deleted"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?CustomAttributeDefinitionEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
