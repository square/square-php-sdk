 ...
 */
class BulkUpsertBookingCustomAttributesResponse extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<string, BookingCustomAttributeUpsertResponse> $values
     */
    #[JsonProperty('values'), ArrayType(['string' => BookingCustomAttributeUpsertResponse::class])]
    ...
    /**
     * @param array{
     *   values?: ?array<string, BookingCustomAttributeUpsertResponse>,
     *   errors?: ?array<Error>,
     * } $values
     */
    ...
    /**
     * @return ?array<string, BookingCustomAttributeUpsertResponse>
     */
    ...
    /**
     * @param ?array<string, BookingCustomAttributeUpsertResponse> $value
     */
