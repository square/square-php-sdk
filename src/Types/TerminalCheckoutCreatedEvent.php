 ...
 */
class TerminalCheckoutCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"terminal.checkout.created"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?TerminalCheckoutCreatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?TerminalCheckoutCreatedEventData $data;
    ...
    /**
     * @return ?TerminalCheckoutCreatedEventData
     */
    public function getData(): ?TerminalCheckoutCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?TerminalCheckoutCreatedEventData $value
     */
    public function setData(?TerminalCheckoutCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
