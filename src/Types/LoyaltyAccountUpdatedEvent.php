 ...
 */
class LoyaltyAccountUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `loyalty.account.updated`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LoyaltyAccountUpdatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LoyaltyAccountUpdatedEventData $data;
    ...
    /**
     * @return ?LoyaltyAccountUpdatedEventData
     */
    public function getData(): ?LoyaltyAccountUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LoyaltyAccountUpdatedEventData $value
     */
    public function setData(?LoyaltyAccountUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
