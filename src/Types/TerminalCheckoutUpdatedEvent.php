 ...
 */
class TerminalCheckoutUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"terminal.checkout.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?TerminalCheckoutUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?TerminalCheckoutUpdatedEventData $data;
    ...
    /**
     * @return ?TerminalCheckoutUpdatedEventData
     */
    public function getData(): ?TerminalCheckoutUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?TerminalCheckoutUpdatedEventData $value
     */
    public function setData(?TerminalCheckoutUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
