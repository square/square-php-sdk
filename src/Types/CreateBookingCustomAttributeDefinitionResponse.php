 ...
 */
class CreateBookingCustomAttributeDefinitionResponse extends JsonSerializableType
{
    /**
     * @var ?CustomAttributeDefinition $customAttributeDefinition The newly created custom attribute definition.
     */
