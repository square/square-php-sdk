 ...
 */
class ResumeSubscriptionResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?Subscription $subscription The resumed subscription.
     */
    #[JsonProperty('subscription')]
    private ?Subscription $subscription;

    /**
     * @var ?array<SubscriptionAction> $actions A list of `RESUME` actions created by the request and scheduled for the subscription.
     */
