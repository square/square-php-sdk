 ...
 */
class LaborShiftUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `labor.shift.updated`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LaborShiftUpdatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LaborShiftUpdatedEventData $data;
    ...
    /**
     * @return ?LaborShiftUpdatedEventData
     */
    public function getData(): ?LaborShiftUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LaborShiftUpdatedEventData $value
     */
    public function setData(?LaborShiftUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
