 ...
 */
class LocationUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"location.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?LocationUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?LocationUpdatedEventData $data;
     ...
     */
    public function getData(): ?LocationUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?LocationUpdatedEventData $value
     */
    public function setData(?LocationUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
