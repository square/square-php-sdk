 ...
 */
class CatalogVersionUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?CatalogVersionUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?CatalogVersionUpdatedEventData $data;
    ...
    /**
     * @return ?CatalogVersionUpdatedEventData
     */
    public function getData(): ?CatalogVersionUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?CatalogVersionUpdatedEventData $value
     */
    public function setData(?CatalogVersionUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
