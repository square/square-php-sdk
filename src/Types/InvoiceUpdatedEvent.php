 ...
 */
class InvoiceUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"invoice.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?InvoiceUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?InvoiceUpdatedEventData $data;
    ...
    /**
     * @return ?InvoiceUpdatedEventData
     */
    public function getData(): ?InvoiceUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?InvoiceUpdatedEventData $value
     */
    public function setData(?InvoiceUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
