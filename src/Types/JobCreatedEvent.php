 ...
 */
class JobCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"job.created"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?JobCreatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?JobCreatedEventData $data;
    ...
    /**
     * @return ?JobCreatedEventData
     */
    public function getData(): ?JobCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?JobCreatedEventData $value
     */
    public function setData(?JobCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
