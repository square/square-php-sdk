 ...
 */
class RefundUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"refund.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?RefundUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?RefundUpdatedEventData $data;
    ...
    /**
     * @return ?RefundUpdatedEventData
     */
    public function getData(): ?RefundUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?RefundUpdatedEventData $value
     */
