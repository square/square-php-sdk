 ...
 */
class TransferOrderUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"transfer_order.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?TransferOrderUpdatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?TransferOrderUpdatedEventData $data;
    ...
    /**
     * @return ?TransferOrderUpdatedEventData
     */
    public function getData(): ?TransferOrderUpdatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?TransferOrderUpdatedEventData $value
     */
    public function setData(?TransferOrderUpdatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
