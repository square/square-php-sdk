 ...
 */
class BankAccountCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"bank_account.created"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?BankAccountCreatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?BankAccountCreatedEventData $data;
    ...
    /**
     * @return ?BankAccountCreatedEventData
     */
    public function getData(): ?BankAccountCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?BankAccountCreatedEventData $value
     */
    public function setData(?BankAccountCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
