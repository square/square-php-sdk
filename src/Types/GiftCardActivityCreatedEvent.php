 ...
 */
class GiftCardActivityCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event. For this event, the value is `gift_card.activity.created`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?GiftCardActivityCreatedEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?GiftCardActivityCreatedEventData $data;
    ...
    /**
     * @return ?GiftCardActivityCreatedEventData
     */
    public function getData(): ?GiftCardActivityCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?GiftCardActivityCreatedEventData $value
     */
    public function setData(?GiftCardActivityCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
