 ...
 */
class BookingCustomAttributeOwnedUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"booking.custom_attribute.owned.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
