 ...
 */
class MerchantCustomAttributeVisibleUpdatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"merchant.custom_attribute.visible.updated"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
