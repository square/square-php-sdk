 ...
 */
class CardForgottenEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of this event. The value is `"card.forgotten"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?CardForgottenEventData $data The data associated with the event.
     */
    #[JsonProperty('data')]
    private ?CardForgottenEventData $data;
    ...
    /**
     * @return ?CardForgottenEventData
     */
    public function getData(): ?CardForgottenEventData
    {
        return $this->data;
    }

    /**
     * @param ?CardForgottenEventData $value
     */
    public function setData(?CardForgottenEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
