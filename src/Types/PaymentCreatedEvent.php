 ...
 */
class PaymentCreatedEvent extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $type The type of event this represents, `"payment.created"`.
     */
    #[JsonProperty('type')]
    private ?string $type;
    ...
    /**
     * @var ?PaymentCreatedEventData $data Data associated with the event.
     */
    #[JsonProperty('data')]
    private ?PaymentCreatedEventData $data;
    ...
    /**
     * @return ?PaymentCreatedEventData
     */
    public function getData(): ?PaymentCreatedEventData
    {
        return $this->data;
    }

    /**
     * @param ?PaymentCreatedEventData $value
     */
    public function setData(?PaymentCreatedEventData $value = null): self
    {
        $this->data = $value;
        return $this;
    }
