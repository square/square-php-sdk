...
use Square\Types\CreateShiftResponse;
...
use Square\Types\UpdateShiftResponse;
use Square\Labor\Shifts\Requests\DeleteShiftsRequest;
use Square\Types\DeleteShiftResponse;
...
class ShiftsClient
{
     ...
     */
    public function create(CreateShiftRequest $request, ?array $options = null): CreateShiftResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return CreateShiftResponse::fromJson($json);
            }
     ...
     * @throws SquareApiException
     */
    public function get(GetShiftsRequest $request, ?array $options = null): GetShiftResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Production->value,
                    path: "v2/labor/shifts/{$request->getId()}",
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return GetShiftResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SquareException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     * @throws SquareApiException
     */
    public function update(UpdateShiftRequest $request, ?array $options = null): UpdateShiftResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                $json = $response->getBody()->getContents();
                return UpdateShiftResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SquareException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (RequestException $e) {
     ...
     * @throws SquareApiException
     */
    public function delete(DeleteShiftsRequest $request, ?array $options = null): DeleteShiftResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
