...
use Square\Legacy\Apis\ApplePayApi;
use Square\Legacy\Apis\BankAccountsApi;
use Square\Legacy\Apis\BookingCustomAttributesApi;
use Square\Legacy\Apis\BookingsApi;
use Square\Legacy\Apis\CardsApi;
use Square\Legacy\Apis\CashDrawersApi;
use Square\Legacy\Apis\CatalogApi;
use Square\Legacy\Apis\CheckoutApi;
use Square\Legacy\Apis\CustomerCustomAttributesApi;
use Square\Legacy\Apis\CustomerGroupsApi;
use Square\Legacy\Apis\CustomersApi;
use Square\Legacy\Apis\CustomerSegmentsApi;
use Square\Legacy\Apis\DevicesApi;
use Square\Legacy\Apis\DisputesApi;
use Square\Legacy\Apis\EmployeesApi;
use Square\Legacy\Apis\EventsApi;
use Square\Legacy\Apis\GiftCardActivitiesApi;
use Square\Legacy\Apis\GiftCardsApi;
use Square\Legacy\Apis\InventoryApi;
use Square\Legacy\Apis\InvoicesApi;
use Square\Legacy\Apis\LaborApi;
use Square\Legacy\Apis\LocationCustomAttributesApi;
use Square\Legacy\Apis\LocationsApi;
use Square\Legacy\Apis\LoyaltyApi;
use Square\Legacy\Apis\MerchantCustomAttributesApi;
use Square\Legacy\Apis\MerchantsApi;
use Square\Legacy\Apis\MobileAuthorizationApi;
use Square\Legacy\Apis\OAuthApi;
use Square\Legacy\Apis\OrderCustomAttributesApi;
use Square\Legacy\Apis\OrdersApi;
use Square\Legacy\Apis\PaymentsApi;
use Square\Legacy\Apis\PayoutsApi;
use Square\Legacy\Apis\RefundsApi;
use Square\Legacy\Apis\SitesApi;
use Square\Legacy\Apis\SnippetsApi;
use Square\Legacy\Apis\SubscriptionsApi;
use Square\Legacy\Apis\TeamApi;
use Square\Legacy\Apis\TerminalApi;
use Square\Legacy\Apis\TransactionsApi;
use Square\Legacy\Apis\V1TransactionsApi;
use Square\Legacy\Apis\VendorsApi;
use Square\Legacy\Apis\WebhookSubscriptionsApi;
use Square\Legacy\Authentication\BearerAuthCredentialsBuilder;
use Square\Legacy\Authentication\BearerAuthManager;
use Square\Legacy\Utils\CompatibilityConverter;
