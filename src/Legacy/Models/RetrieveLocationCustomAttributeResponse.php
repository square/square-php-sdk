...
/**
 * Represents a
 * [RetrieveLocationCustomAttribute]($e/LocationCustomAttributes/RetrieveLocationCustomAttribute)
 * response.
 * Either `custom_attribute_definition` or `errors` is present in the response.
 */
class RetrieveLocationCustomAttributeResponse implements \JsonSerializable
{
    /**
