...
/**
 * Represents an
 * [UpsertBookingCustomAttribute]($e/BookingCustomAttributes/UpsertBookingCustomAttribute) request.
 */
class UpsertBookingCustomAttributeRequest implements \JsonSerializable
{
    /**
     * @var CustomAttribute
     */
