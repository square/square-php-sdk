...
/**
 * Represents an
 * [UpdateCustomerCustomAttributeDefinition]($e/CustomerCustomAttributes/UpdateCustomerCustomAttributeD
 * efinition) response.
 * Either `custom_attribute_definition` or `errors` is present in the response.
 */
class UpdateCustomerCustomAttributeDefinitionResponse implements \JsonSerializable
{
    /**
