...
/**
 * Represents a
 * [RetrieveBookingCustomAttribute]($e/BookingCustomAttributes/RetrieveBookingCustomAttribute) response.
 * Either `custom_attribute_definition` or `errors` is present in the response.
 */
class RetrieveBookingCustomAttributeResponse implements \JsonSerializable
{
    /**
