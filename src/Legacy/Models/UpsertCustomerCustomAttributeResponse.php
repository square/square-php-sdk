...
/**
 * Represents an
 * [UpsertCustomerCustomAttribute]($e/CustomerCustomAttributes/UpsertCustomerCustomAttribute) response.
 * Either `custom_attribute_definition` or `errors` is present in the response.
 */
class UpsertCustomerCustomAttributeResponse implements \JsonSerializable
{
    /**
