...
class CancelTransferOrderRequest extends JsonSerializableType
{
    /**
     * @var string $transferOrderId The ID of the transfer order to cancel. Must be in STARTED or PARTIALLY_RECEIVED status.
     */
