...
use Square\Locations\Transactions\Requests\ListTransactionsRequest;
use Square\Types\ListTransactionsResponse;
...
class TransactionsClient
{
     ...
     */
    public function list(ListTransactionsRequest $request, ?array $options = null): ListTransactionsResponse
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    ...
                    path: "v2/locations/{$request->getLocationId()}/transactions",
     ...
     * @throws SquareApiException
     */
    public function get(GetTransactionsRequest $request, ?array $options = null): GetTransactionResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::Production->value,
                    path: "v2/locations/{$request->getLocationId()}/transactions/{$request->getTransactionId()}",
                    method: HttpMethod::GET,
                ),
                $options,
            );
