...
class BulkRetrieveCustomersRequest extends JsonSerializableType
{
    /**
     * @var array<string> $customerIds The IDs of the [customer profiles](entity:Customer) to retrieve.
     */
