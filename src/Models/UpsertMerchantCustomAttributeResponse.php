...
/**
 * Represents an
 * [UpsertMerchantCustomAttribute]($e/MerchantCustomAttributes/UpsertMerchantCustomAttribute) response.
 * Either `custom_attribute_definition` or `errors` is present in the response.
 */
class UpsertMerchantCustomAttributeResponse implements \JsonSerializable
{
    /**
