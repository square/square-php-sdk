...
/**
 * Represents a
 * [RetrieveMerchantCustomAttributeDefinition]($e/MerchantCustomAttributes/RetrieveMerchantCustomAttrib
 * uteDefinition) response.
 * Either `custom_attribute_definition` or `errors` is present in the response.
 */
class RetrieveMerchantCustomAttributeDefinitionResponse implements \JsonSerializable
{
    /**
