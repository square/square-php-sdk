...
/**
 * Represents an
 * [UpdateMerchantCustomAttributeDefinition]($e/MerchantCustomAttributes/UpdateMerchantCustomAttributeD
 * efinition) response.
 * Either `custom_attribute_definition` or `errors` is present in the response.
 */
class UpdateMerchantCustomAttributeDefinitionResponse implements \JsonSerializable
{
    /**
