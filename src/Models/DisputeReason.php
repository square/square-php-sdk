...
class DisputeReason
{
     ...
     * To challenge this dispute, provide specific and concrete evidence that the cardholder agreed to the
     * amount charged.
     */
    ...
    /**
     * The cardholder claims the product or service was provided but the quality of the deliverable did
     * not align with the expectations of the cardholder based on the description.
     * To challenge this dispute, provide specific and concrete evidence that shows the cardholder is in
     * possession of the product as described, or received the service as described (agreed) upon.
     */
    public const NOT_AS_DESCRIBED = 'NOT_AS_DESCRIBED';

    /**
     * The cardholder claims the product or service was not received by the cardholder within the stated
     * time frame.
     * To challenge this dispute, provide specific and concrete evidence to prove that the cardholder is in
     * possession of or received the product or service sold.
     */
    ...
    /**
     * A chip-enabled card was not processed through a compliant chip-card reader (e.g. it was swiped
     * instead of dipped into a chip-card reader).
     * You cannot challenge this dispute because the payment didn’t comply with EMV security requirements.
